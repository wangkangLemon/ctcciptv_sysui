        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    sex: { required: true },
                    mobile: { pattern: /^1[3456789]\d{9}$/, required: true, type: 'string', message: '请输入正确的手机号', trigger: 'blur' },
                    // email: { pattern: /^\w+([-+.]\w+)*@\w+([-+.]\w+)*.\w+([-+.]\w+)*$/, required: false, message: '请输入邮箱地址', trigger: 'blur' },
